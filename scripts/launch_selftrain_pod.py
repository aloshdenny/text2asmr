...
def kick(host, port):
    files = ["scripts/prep_clap_v2.py", "scripts/train_clap_v3.py", "scripts/pseudo_label_clap.py", "scripts/selftrain_clap.sh", "scripts/prep_yt_chapters.py", "scripts/clapv4.sh"]
