...
QUERIES = {
    ...
    "_round2_m": ["M4F script fill", "M4F improv", "M4F roleplay", "M4F sfw", "M4F nsfw", "M4F audio", "M4A audio", "M4M audio", "M4TF", "M4TM", "mdom", "msub", "boyfriend roleplay", "husband roleplay", "daddy dom", "dilf", "big brother", "roommate m4f", "neighbor m4f", "coworker m4f", "boss m4f", "teacher m4f", "doctor m4f", "stranger m4f", "vampire m4f", "incubus", "werewolf", "orc", "dragon", "knight", "prince", "villain", "soldier", "cowboy", "mafia", "yandere m4f", "tsundere m4f", "praise m4f", "degradation m4f", "breeding m4f", "creampie m4f", "cunnilingus", "fingering", "missionary", "doggy", "spanking", "choking", "edging m4f", "hypno m4f", "asmr m4f", "ear to ear m4f", "binaural m4f", "growling", "grunting", "moaning m4f", "male whimpers", "comfort m4f", "aftercare m4f", "bedtime m4f", "sleep m4f", "rain m4f", "wholesome m4f", "l-bombs m4f"],
